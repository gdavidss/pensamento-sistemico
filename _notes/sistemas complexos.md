- Sistemas complexos estão presentes em todos os lugares em nossa volta. De fato, não é uma tarefa difícil nomear diversos sistemas complexos que existem ao redor nesse exato momento. Vemos tais exemplos em plantas, em computadores, nos países em que estamos inseridos. Não importa aonde você esteja, sistemas complexos sempre estarão lá.
- Aliás, não é loucura dizer que você é um grande. De fato, você é um grande sistema complexo de cerca de 30 trilhões de células. Em que 3.8 milhões de células estão sendo geradas a cada segundo em seu corpo.
