- Sistemas complexos estão em quase todos os lugares. Se eu te pedisse aqui para nomear ao menos três sistemas complexos que existem a sua volta agora, você certamente não acharia essa uma tarefa arduosa. Sistemas complexos aparecem em plantas, em computadores, em organizações coletivas, economias humanas. Não importa aonde quer que você esteja, sistemas complexos sempre estarão junto de você.
