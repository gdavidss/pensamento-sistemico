- Sistemas complexos estão presentes em todos os lugares em nossa volta. De fato, não é uma tarefa difícil nomear diversos sistemas complexos que existem ao redor nesse exato momento. Vemos tais exemplos em plantas, em computadores, nos países em que estamos inseridos.
- Não importa aonde você esteja, é impossível escapar de
