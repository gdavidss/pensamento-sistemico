...
- **A definição Matemática de complexidade**
	...
	- Vamos imaginar dois exemplos.
		...
		- Resposta correta.
	- Nesse pequeno exercício mental, o seu primo te ofereceu duas sequências de diferentes complexidades. A prova de que uma
	- A primeira sequência foi muito menos complexa que a segunda.
