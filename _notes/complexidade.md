...
- **A definição Matemática de complexidade**
	...
	- which means that complexity of x is the minimal length `(P) among all programs P with the property that, when run on a universal computer (Turing machine) TU ,will output x.
